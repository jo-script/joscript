  ...
  return (
    <div id='home' className=' w-full px-[7%] flex justify-between items-center gap-10 max-[1130px]:flex-col-reverse max-[1130px]:mt-16 ' >
        ...
        <div className='text-end max-[1130px]:text-center ' >
          ...
          {/* <br/> */}
          <p className='text-[#4A5568] text-[23px]'>نهدف إلى نشر المعرفة البرمجية ومساعدة الآخرين على تعلمها</p>
          <p className='text-[#4A5568] text-[23px]'>نسعى لتوفير بيئة تعليمية إيجابية وداعمة للطلاب من جميع المستويات، من المبتدئين إلى المتقدمين</p>
          <br/>
          <br/>
