  ...
  return (
    <div id='home' className=' w-full px-[7%] flex justify-between items-center gap-10 max-[1130px]:flex-col-reverse max-[1130px]:mt-16 ' >
        ...
        <div className='text-end max-[1130px]:text-center ' >
          ...
          <h1  className='text-[#eef6ff] text-[48px] mb-[10px] max-[523px]:text-[44px]'>أكاديمية لتعليم <span  className='text-[#FAA000] '>البرمجة</span> </h1>
          {/* <br/> */}
          <p className='text-[#9da1a7] text-[23px] max-[500px]:text-[20px]'>نهدف إلى نشر المعرفة البرمجية ومساعدة الآخرين على تعلمها</p>
          <p className='text-[#9da1a7] text-[23px] max-[500px]:text-[20px]'>نسعى لتوفير بيئة تعليمية إيجابية وداعمة للطلاب من جميع المستويات، من المبتدئين إلى المتقدمين</p>
          <br/>
          <br/>
