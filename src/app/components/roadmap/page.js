  ...
  return (
    <div id='roadmap' className=' w-full px-[2%] flex flex-col items-center justify-center py-24 relative'>
      ...
      <div className="w-full flex flex-wrap items-center justify-center gap-5 max-[712px]:gap-1 mt-16 max-[673px]:grid max-[673px]:grid-cols-2 place-items-center max-[673px]:w-[95%] max-[673px]:gap-2">
        ...
        <Link href='/components/roadmap/mobileApplication' className='w-60 h-40 max-[673px]:w-full'>
        ...
        <Link href='/components/roadmap/uiux' className='w-60 h-40 max-[673px]:w-full'>
...
export function Maps() {
  return(
    <div className="w-full flex flex-wrap items-start justify-center gap-5  max-[712px]:gap-1 mt-16 max-[673px]:grid max-[673px]:grid-cols-2 place-items-center max-[673px]:w-[95%] max-[673px]:gap-2">
