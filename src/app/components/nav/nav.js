    ...
    <div id='nav' className={` nav ${scroll ? 'shadow-md' : 'shadow-[0]'}  bg-[#0d1117] w-full h-[80px] border-[#848d9778]  border-b-[1px]  flex items-center justify-between gap-3 px-[5%] fixed top-0 z-[444]`}>
      ...
      <div className=' min-[1000px]:w-full flex items-center min-[1000px]:flex-row-reverse justify-between gap-[3%]'>
        ...
        <div id='links' className='w-full flex items-center gap-[3%] text-white max-[1000px]:hidden ' style={{ direction: 'rtl' }}>
          ...
          <a href="#teamwork" className={linksStyle}><button className='link'>فريق ألعمل</button></a>
          <a href="" className={linksStyle}><button className='link'>حول joscript</button> </a>
        </div>

        {/* icon list */}
        <BsList onClick={openSdeBare} className='scale-[2.3] cursor-pointer text-[#b0bbc8] ml-10  min-[1000px]:hidden' />
      </div>
