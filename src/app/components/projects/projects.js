...
function Projects() {
    ...
    return (
        ...
        <div id='projects' className='w-full flex flex-col items-center justify-center mt-[100px] relative '>
            <p className='bg-[#faa000] h-[3px] w-[10%] '></p>
            <h1 className='text-[#0c0c0c] text-[35px] mt-4 '>المشاريع</h1>
            <p className='text-[20px] text-[#4A5568] text-center mt-2 max-[500px]:text-[16px] max-[500px]:w-[70%]'>المشاريع التي نفذها الطلاب خلال مدة الكورس وبعد التخرج</p>
            ...
            <div id='projects-nav' className=' w-[95%] flex items-center justify-center max-[800px]:justify-normal p-3 text-[#0c0c0c] text-[18px] gap-5 overflow-auto mt-9 max-[500px]:text-[15px]'>
                ...
                <button onClick={() => pages('UiUx')} className={`min-w-[66px] hover:text-[#faa000] hover:scale-[1.1] transition-all delay-75 ${showPages === 'UiUx' ? 'text-[#faa000] font-bold underline decoration-[2px]' : 'text-[#0c0c0c] font-thin'}`}>UI / UX</button>
            </div>
