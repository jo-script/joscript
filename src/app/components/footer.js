                ...
                <div className="space-y-4">
                    <div className=" space-y-2 text-start ">
                        ...
                        <div className="flex flex-col justify-start gap-2 text-gray-400">
                            ...
                            <a href="https://www.youtube.com/@jo-script" target='_blank' className="flex items-center gap-2 mr-[-10px] justify-center text-gray-400 text-[16px] hover:underline hover:text-gray-200">
