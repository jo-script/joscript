            ...
            <div className="w-full flex flex-wrap items-center justify-center gap-y-5 gap-x-5 mt-12">
                {
                    teamWork.map((data, index) => (
                        <div id='cardProfile' key={index} className=" card w-[290px] backdrop-blur-md bg-[#0d1117] border-[1px] border-[#848d9778]  rounded-md flex gap-3 items-start justify-between p-[7px] hover:scale-105 cursor-default transition-all delay-75">
                            ...
                            <div className=' w-full h-[100px] flex items-start flex-col gap-3 relative'>
                                <div className="flex flex-col justify-center h-full ">
                                    <p className='title text-[#eef6ff] text-[20px] font-normal '>{data.name}</p>
                                    <p className='text text-[#9da1a7] text-[16px] font-normal '>{data.jop}</p>
                                </div>
                                {/* links */}
