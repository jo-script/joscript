      ...
      <div className='flex items-center justify-center  flex-wrap gap-5 max-[712px]:gap-1 max-[471px]:gap-1 mt-16 '>
        {
          service.map((item, index) => (
            <div id='card' key={index} className='w-[330px] h-auto bg-[#ffffff] rounded-[10px] shadow-[#00000015] shadow-lg px-4 py-9 flex flex-col justify-center cursor-default border-[1px] hover:border-[#fa9e00bc] hover:scale-[1.03] transition-all delay-75 max-[712px]:w-[220px]  max-[550px]:h-auto  max-[471px]:h-[200px]  max-[471px]:w-[175px]  '>
              ...
              <p id='text' className={`text-[18.5px] text-[#4A5568] text-start mt-5 ${mediaText}`}>{item.text}</p>
            </div>
          ))
        }
      </div>
